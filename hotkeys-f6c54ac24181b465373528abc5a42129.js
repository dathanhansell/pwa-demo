...
const n=t-48
n<10&&n>=0&&activateHotkeyElement(n,e,o),13===t&&document.activeElement.click()})),addEventListener("popstate",(()=>{console.log("popstate"),setTimeout(checkDOMChange,200)})),addEventListener("load",(()=>{console.log("load")})),addEventListener("DOMContentLoaded",(()=>{console.log("DOMContentLoaded"),setTimeout(checkDOMChange,1e3)
